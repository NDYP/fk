        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('bimbingan/index') ?>" class="btn btn-social btn-sm btn-warning"><span
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">Kontak</label>
                                    <input name="kontak_ortu" value="<?= $mahasiswa['kontak_ortu'] ?: '-'; ?>"
                                        type=" text" class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input name="ukt" value="<?= $mahasiswa['jalur_masuk'] ?: '-'; ?>"
                                                type=" text" class="form-control" id="" placeholder="" readonly>
