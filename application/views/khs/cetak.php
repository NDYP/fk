...
<body>
    ...
    <table width=100%>
        <tr>
            ...
            <td width=5 style="padding: 1px; margin: 1px">: </td>
            <td width=130><?= $krs['program_studi'] ?></td>
        </tr>
        <tr>
            <td width=70>
                NIM
            ...
            <td width=5 style="padding: 1px; margin: 1px">: </td>
            <td width=130>
                <?= $krs['prodi'] < 4 ? 'Sarjana / S1' : 'Dokter Umum'; ?> </td>
        </tr>
        <tr>
            <td width=70>
                Pembimbing Akademik
            ...
            <td width=5 style="padding: 1px; margin: 1px">: </td>
            <td width=130> <?= $krs['dosen_pa'] ?> </td>
            <td></td>
            <td width=90>
                Semester
            </td>
            <td width=5 style="padding: 1px; margin: 1px">: </td>
            <td width=130> <?= $krs['smt'] ?> </td>
        </tr>
    </table>
    <br>
    ...
    <table class="table-responsive" cellspacing="0" border="">
        ...
        <tr>
            ...
            <td style="text-align: center;border-bottom:0;border-left:0; border-right:0;border-style: dashed;" width=>
                <?= $sks_semester_lulus['sks_lulus'] ?>
            </td>
            <td style="text-align: center;border-bottom:0;border-left:0; border-right:0;border-style: dashed;" width=>
                <?= $ips['sksn'] ?>
            </td>
            <td style="text-align: center;border-bottom:0;border-left:0; border-right:0;border-style: dashed;" width=>
                <?= number_format($ips['sksn'] / $ips['sks'], 2) ?>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;border-bottom:0;border-left:0; border-right:0;border-style: dashed;" width=>
            ...
            <td style="text-align: center;border-bottom:0;border-left:0; border-right:0;border-style: dashed;" width=>
                <?= $sks_kumultatif_beban['sks_lulus'] ?: '-' ?>
            </td>
            <td style="text-align: center;border-bottom:0;border-left:0; border-right:0;border-style: dashed;" width=>
