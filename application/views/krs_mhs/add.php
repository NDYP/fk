        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('krs_mhs/index') ?>" class="btn btn-sm btn-warning"><span
                            class="fa fa-list"></span>
                        Kembali</a>
                    <a href="<?= base_url('krs_list/tambah') ?>" class="btn btn btn-sm bg-red"><i
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="ukt" value="<?= $dosen_pa['nama']; ?>" type=" text"
                                        class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="ukt"
                                        value="<?= $registrasi['tahun_akademik']; ?>-<?= $registrasi['semester']; ?>"
                                        type=" text" class="form-control" id="" placeholder="" readonly>
                                    <input name="id_tahun_akademik" value="<?= $registrasi['id_tahun_ajaran']; ?>"
                                        type="hidden" class="form-control" id="" placeholder="" readonly>
                                    <input name="id_registrasi" value="<?= $registrasi['id_registrasi']; ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="semester" value="<?= $semester['semester'] + 1; ?>" type=" text"
                                        class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">IPS</label>
                                    <input name="ukt" value="<?= $semester['ips'] ?: 0; ?>" type=" text"
                                        class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="">IPK</label>
                                    <input name="ukt" value="<?= $semester['ipk'] ?: 0; ?>" type=" text"
                                        class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="ukt" value="<?= $sks_kumul['sks'] ?: 0; ?>" type=" text"
                                        class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="ukt" value="<?= $sks_yad['sks'] ?: 0; ?>" type=" text"
                                        class="form-control" id="" placeholder="" readonly>
                                </div>
                            </div>
