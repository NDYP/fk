                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">IPS</label>
                                        <input name="ips" value="<?= $semester['ips'] ?: 0; ?>" type=" text"
                                            class="form-control" id="" placeholder="" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="">IPK</label>
                                        <input name="ipk" value="<?= $semester['ipk'] ?: 0; ?>" type=" text"
                                            class="form-control" id="" placeholder="" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="sks_kumultatif" value="<?= $sks_kumul['sks'] ?: 0; ?>" type=" text"
                                            class="form-control" id="" placeholder="" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input name="sks_yad" value="<?= $sks_yad['sks'] ?: 0; ?>" type=" text"
                                            class="form-control" id="" placeholder="" readonly>
                                    </div>
                                </div>
                            </div>
