        ...
        <div class="col-xs-12">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('dosen/index') ?>" class="btn btn-sm btn-warning"><span
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="nip" value="<?= $dosen['nip']; ?>" type="text" class="form-control"
                                        id="" placeholder="isi ...">
                                    <input name="id_dosen" value="<?= $dosen['id_dosen']; ?>" type="hidden"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="email" value="<?= $dosen['email']; ?>" type=" text"
                                        class="form-control" id="" placeholder="isi ...">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="kontak" value="<?= $dosen['kontak']; ?>" type=" text"
                                        class="form-control" id="" placeholder="isi ...">
                                </div>
                            </div>
                            <div class="col-md-4">
