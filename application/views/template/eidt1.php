                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="jenis" class="form-control select6" style="width: 100%;">
                                        ...
                                        <option value="SOLID"
                                            <?php if ($fat['jenis'] === 'SOLID') echo 'selected="selected"'; ?>
                                            name="jenis">SOLID
                                        </option>
                                        <option value="NON SOLID"
                                            <?php if ($fat['jenis'] === 'NON SOLID') echo 'selected="selected"'; ?>
                                            name="jenis">
                                            Non Solid
                                        </option>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status_pembangunan" class="form-control select5" style="width: 100%;">
                                        ...
                                        <option value="Plan/Ongoing"
                                            ...
                                            <?= set_select('status_pembangunan', 'Plan/Ongoing'); ?>
                                            name="status_pembangunan">
                                            Plan/Ongoing
                                        </option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="long" value="<?= $fat['long']; ?>" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="lat" value="<?= $fat['lat']; ?>" type="text"
                                                class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="kapasitas_port_max" value="<?= $fat['kapasitas_port_max']; ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="kapasitas_port_terpasang"
                                        value="<?= $fat['kapasitas_port_terpasang']; ?>" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="power_in" value="<?= $fat['power_in']; ?>" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="power_out" value="<?= $fat['power_out']; ?>" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="tray_fdt" value="<?= $fat['tray_fdt']; ?>" type="text"
                                        class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="port_fdt" value="<?= $fat['port_fdt']; ?>"
                                        class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input name="tanggal_instalasi" value="<?= $fat['tanggal_instalasi']; ?>"
