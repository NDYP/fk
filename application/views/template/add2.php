                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="prodi" value="<?= set_value('prodi'); ?>" type=" text" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="status_pembangunan" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="Ready for sale" <?= set_select('status_pembangunan', 'Ready for sale'); ?> name="status_pembangunan">
                                            Ready for sale
                                        </option>
                                        <option value="Plan/Ongoing" <?= set_select('status_pembangunan', 'Plan/Ongoing'); ?> name="status_pembangunan">
                                            Plan/Ongoing
                                        </option>
                                        <option value="Plan/Ongoing" <?= set_select('status_pembangunan', 'Proses pembangunan'); ?> name="status_pembangunan">
                                            Proses pembangunan
                                        </option>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="kapasitas_port_max" value="<?= set_value('kapasitas_port_max'); ?>" type="text" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="kapasitas_port_terpasang" value="<?= set_value('kapasitas_port_terpasang'); ?>" type="text" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="power_in" value="<?= set_value('power_in'); ?>" type="text" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="power_out" value="<?= set_value('power_out'); ?>" type="text" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="tray_fdt" value="<?= set_value('tray_fdt'); ?>" type="text" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="port_fdt" value="<?= set_value('port_fdt'); ?>" class="form-control" id="exampleInputEmail1" placeholder="isi ...">
