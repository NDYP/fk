        ...
        <div class="col-xs-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('registrasi_mhs/index') ?>" class="btn btn-social btn-sm btn-warning"><span
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_tahun_ajaran" class="form-control select2" style="width: 100%;">
                                        ...
                                        <?php if ($registrasi['id_tahun_ajaran'] == $x['id_tahun_ajaran']) : ?>
                                        <option
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="va" value="<?= $registrasi['va']; ?>" type="text" class="form-control"
