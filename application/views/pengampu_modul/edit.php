                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="id_pengampu_modul"
                                        value="<?= $pengampu_modul['id_pengampu_modul']; ?>">
                                    <select name="id_modul" class="form-control select2" style="width: 100%;">
                                        ...
                                        <?php if ($pengampu_modul['id_modul'] == $x['id_modul']) : ?>
                                        <option
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_dosen" class="form-control select2" style="width: 100%;">
                                        ...
                                        <?php if ($pengampu_modul['id_dosen'] == $x['id_dosen']) : ?>
                                        <option
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="id_tahun_ajaran" class="form-control select2" style="width: 100%;">
                                        ...
                                        <?php if ($pengampu_modul['id_tahun_ajaran'] == $x['id_tahun_ajaran']) : ?>
                                        <option
